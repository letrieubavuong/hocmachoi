...
export type TargetMode = 'SELF' | 'OPPONENT';
...
export const POWER_UP_CONFIG: Record<PowerUpType, PowerUpMeta> = {
  ATTACK: {
    type: 'ATTACK',
    title: 'TẤN CÔNG',
  ...
  FREEZE: {
    ...
    description: 'Đóng băng màn hình của 1 đối thủ trong 6 giây!',
    targetMode: 'OPPONENT',
    icon: Snowflake,
    badgeColor: 'bg-cyan-500/20 text-cyan-300 border-cyan-500/40',
    cardBgGradient: 'from-cyan-950/80 via-slate-900 to-blue-950/80',
  ...
  BOMB: {
    type: 'BOMB',
    title: 'BỎM NỔ',
    subTitle: 'TRỪ ĐIỂM ĐỐI THỦ',
    description: 'Thả nổ nổ tung và trừ điểm đối thủ!',
    targetMode: 'OPPONENT',
    icon: Bomb,
    badgeColor: 'bg-rose-500/20 text-rose-400 border-rose-500/40',
    cardBgGradient: 'from-rose-950/80 via-slate-900 to-red-950/80',
  ...
  ROCKET_BOOST: {
    ...
    description: 'Tăng tốc bứt phá điểm số tức thì!',
    targetMode: 'SELF',
    icon: Rocket,
  ...
  REFLECT_SHIELD: {
    ...
    description: 'Phản lại đòn tấn công từ đối thủ về chính chủ!',
    targetMode: 'SELF',
    icon: ShieldAlert,
...
export const REWARD_OPTIONS: PowerUpType[] = ['ATTACK', 'SHIELD', 'ORACLE_5050', 'MYSTERY_BOX'];
